...
conf = ConnectionConfig(
    MAIL_USERNAME=settings.MAIL_USERNAME or "test@gmail.com",
    MAIL_PASSWORD=SecretStr(settings.MAIL_PASSWORD or "password"), 
    MAIL_FROM=settings.MAIL_FROM or "test@gmail.com",
